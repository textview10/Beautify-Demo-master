        ...
        TexturePbufferRenderer   surfaceRun  = new TexturePbufferRenderer() {
            ...
            protected void initGLComponents() {
                ...
                for (int i = 0; i < mInitCount; i++) {
                    ...
                    resCode |= BeaurifyJniSdk.preViewInstance().nativeCreateBeautyHandle(appContext, 1280,
                            720, 90, Util.MG_FPP_DETECTIONMODE,
                            ConUtil.getFileContent(appContext, R.raw.mgbeautify_1_2_4_model),
                            ConUtil.getFileContent(appContext, R.raw.detect_model),
                            ConUtil.getFileContent(appContext, R.raw.dense_model)
                    );
