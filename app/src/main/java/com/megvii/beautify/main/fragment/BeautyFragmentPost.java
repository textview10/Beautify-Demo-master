...
public class BeautyFragmentPost extends BaseFragment {
    @BindView(R.id.skin)
    ...
    //@BindView(R.id.remove_speckles)
    //SeekBarRelativeLayout removeSpecklesView;
    @BindView(R.id.remove_eyebags)
    SeekBarRelativeLayout removeEyebagsView;
    //@BindView(R.id.high_nose_bridge)
    //SeekBarRelativeLayout highNoseBridgeView;
    @BindView(R.id.up_cheek)
    SeekBarRelativeLayout upCheekView;
    //@BindView(R.id.skin_balance)
    //SeekBarRelativeLayout skinBalanceView;
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.beauty_fragment_post, null);
    ...
    private SeekBar.OnSeekBarChangeListener mOnSeekBarChangeListenerHighNoseBridge = new SeekBar.OnSeekBarChangeListener() {
        @Override
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            //SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_ADD_PINK,progress);
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            int progress = seekBar.getProgress();
            SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_HIGH_NOSEBRIDGE,progress);
        }
    };

    private SeekBar.OnSeekBarChangeListener mOnSeekBarChangeListenerUpCheek = new SeekBar.OnSeekBarChangeListener() {
        @Override
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            //SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_ADD_PINK,progress);
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            int progress = seekBar.getProgress();
            SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_UPCHEEK,progress);
        }
    };

    private SeekBar.OnSeekBarChangeListener mOnSeekBarChangeListenerSkinBalance = new SeekBar.OnSeekBarChangeListener() {
        @Override
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            //SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_ADD_PINK,progress);
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            int progress = seekBar.getProgress();
            SetBeautyParam(BeaurifyJniSdk.MG_BEAUTIFY_SKIN_BALANCE,progress);
        }
    };
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //removeSpecklesView.setmTitle(R.string.removespeckles);
        removeEyebagsView.setmTitle(R.string.removeeyebags);
        //highNoseBridgeView.setmTitle(R.string.highnosebridge);
        upCheekView.setmTitle(R.string.upcheek);
        //skinBalanceView.setmTitle(R.string.skinbalance);
        ...
        //removeSpecklesView.setOnSeekBarChangeListener(mOnSeekBarChangeListenerRemoveSpeckles);
        removeEyebagsView.setOnSeekBarChangeListener(mOnSeekBarChangeListenerRemoveEyebags);
        //highNoseBridgeView.setOnSeekBarChangeListener(mOnSeekBarChangeListenerHighNoseBridge);
        upCheekView.setOnSeekBarChangeListener(mOnSeekBarChangeListenerUpCheek);
        //skinBalanceView.setOnSeekBarChangeListener(mOnSeekBarChangeListenerSkinBalance);
        ...
        //removeSpecklesView.setProgress((int)(Util.CURRENT_MG_BEAUTIFY_REMOVE_SPECKLES*Util.BEAUTIFY_TRANS_COEFFICIENT));
        removeEyebagsView.setProgress((int)(Util.CURRENT_MG_BEAUTIFY_REMOVE_EYEBAGS*Util.BEAUTIFY_TRANS_COEFFICIENT));
        //highNoseBridgeView.setProgress((int)(Util.CURRENT_MG_BEAUTIFY_HIGH_NOSE_BRIDGE*Util.BEAUTIFY_TRANS_COEFFICIENT));
        upCheekView.setProgress((int)(Util.CURRENT_MG_BEAUTIFY_UP_CHEEK*Util.BEAUTIFY_TRANS_COEFFICIENT));
        //skinBalanceView.setProgress((int)(Util.CURRENT_MG_BEAUTIFY_SKIN_BALANCE*Util.BEAUTIFY_TRANS_COEFFICIENT));
    }
    ...
    private void SetBeautyParam(int beautyType, int progress){
        ...
        switch (beautyType){
            ...
            case BeaurifyJniSdk.MG_BEAUTIFY_REMOVE_EYEBAGS:
                ...
                break;
            case BeaurifyJniSdk.MG_BEAUTIFY_HIGH_NOSEBRIDGE:
                if(Math.abs(Util.CURRENT_MG_BEAUTIFY_HIGH_NOSE_BRIDGE - chooseValue) >0.1){
                    Util.CURRENT_MG_BEAUTIFY_HIGH_NOSE_BRIDGE = chooseValue;
                    if(null != callback ){
                        callback.onFragmantChanged(0,0);
                    }
                }
                break;
            case BeaurifyJniSdk.MG_BEAUTIFY_UPCHEEK:
                if(Math.abs(Util.CURRENT_MG_BEAUTIFY_UP_CHEEK - chooseValue) >0.1){
                    Util.CURRENT_MG_BEAUTIFY_UP_CHEEK = chooseValue;
                    if(null != callback ){
                        callback.onFragmantChanged(0,0);
                    }
                }
                break;
            case BeaurifyJniSdk.MG_BEAUTIFY_SKIN_BALANCE:
                if(Math.abs(Util.CURRENT_MG_BEAUTIFY_SKIN_BALANCE - chooseValue) >0.1){
                    Util.CURRENT_MG_BEAUTIFY_SKIN_BALANCE = chooseValue;
                    if(null != callback ){
                        callback.onFragmantChanged(0,0);
                    }
                }
    ...
    private void setVisable(){
        ...
        if(Util.needGone(",upcheek")){
            upCheekView.setVisibility(View.GONE);
        }
    }
}
