...
import gpuimage.util.TextureRotationUtil;

import static com.megvii.beautify.cameragl.OpenglUtil.TEXTURE_NO_ROTATION;
...
//        MLog.e("init id:"+Thread.currentThread().getId());
    }

    @Override
    public void onSurfaceCreated(final GL10 unused, final EGLConfig config) {
//        MLog.e("onSurfaceCreated id:"+Thread.currentThread().getId());
        GLES20.glClearColor(mBackgroundRed, mBackgroundGreen, mBackgroundBlue, 1);
        GLES20.glDisable(GLES20.GL_DEPTH_TEST);
        mFilter.init();
//        BeaurifyJniSdk.nativeReleaseBeautyHandle();
    ...
    public void onSurfaceChanged(final GL10 gl, final int width, final int height) {
        ...
        int result = BeaurifyJniSdk.preViewInstance().nativeCreateBeautyHandle(MainApp.getContext(), width,
                height, 0,Util.MG_FPP_DENSEDETECTIONMODE_PREVIEW,
                ConUtil.getFileContent(MainApp.getContext(), R.raw.mgbeautify_1_2_4_model), ConUtil.getFileContent(MainApp.getContext(), R.raw.detect_model),ConUtil.getFileContent(MainApp.getContext(), R.raw.dense_model)
...
//        MLog.e("onSurfaceChanged id:"+Thread.currentThread().getId());
        GLES20.glViewport(0, 0, width, height);
        GLES20.glUseProgram(mFilter.getProgram());
        mFilter.onOutputSizeChanged(width, height);
        mOutTextureId = OpenglUtil.initTextureID(width, height);
//        MLog.e("xie surface create w"+width+"h"+height);
        adjustImageScaling();
    ...
    public void onDrawFrame(final GL10 gl) {
        ...
        runAll(mRunOnDraw);
//        MLog.e("onDrawFrame:"+Thread.currentThread().getId()+"   textid"+mGLTextureId+"outtextid  "+mOutTextureId[0]+"   iw"+mImageWidth+"ih"+mImageHeight);

        BeaurifyJniSdk.preViewInstance().nativeProcessTexture(mGLTextureId, mOutTextureId[0],1);
...
//            MLog.e("xie surface"+mSurfaceTexture.hashCode());
        }
    }
    ...
    public void setImageBitmap(final Bitmap bitmap, final boolean recycle) {
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                MLog.e("xie imagew"+mImageWidth+" id"+mGLTextureId);
                adjustImageScaling();
            }
        });
    }
...
//        MLog.e("xie releaseSdk"+Thread.currentThread().getId());
